...
const STYLE_PROMPTS = [
  {
    key: 'hug',
    label: '서로 안고있는 사진',
    prompt: `Using three reference photos — a person's portrait photo, a pet's photo, and an elegant vintage floral pattern backdrop — create one photorealistic professional portrait that places the person and pet naturally in front of the exact floral pattern backdrop shown in the third reference photo, matching its colors and floral pattern exactly; do not invent a different backdrop. Frame it as a wide three-quarter or full-body shot taken from several steps back — both the person and the pet should be visible from at least the waist up (full body preferred), occupying only the center portion of the frame, with generous headroom above their heads and clearly visible floral backdrop on both sides and above. This must absolutely NOT be a tight close-up headshot or a zoomed-in face-and-shoulders crop. Bright, warm, and cozy professional photo studio lighting with soft golden warmth (like a well-lit indoor photo studio, not flat or cold), gentle shallow depth of field, professional studio portrait photography, cheerful and upbeat atmosphere. The person is tenderly hugging and cradling the pet close to their chest, both looking affectionate with a big bright genuine smile and happy sparkling eyes, natural skin tones, the pet's fur and the person's face must closely match the reference photos. Horizontal orientation, high resolution, no text, no watermark.`,
  },
  {
    key: 'smile',
    label: '정면 보고 웃는 평범한 사진',
    prompt: `Using three reference photos — a person's portrait photo, a pet's photo, and an elegant vintage floral pattern backdrop — create one photorealistic professional portrait that places the person and pet naturally in front of the exact floral pattern backdrop shown in the third reference photo, matching its colors and floral pattern exactly; do not invent a different backdrop. Frame it as a wide three-quarter or full-body shot taken from several steps back — both the person and the pet should be visible from at least the waist up (full body preferred), occupying only the center portion of the frame, with generous headroom above their heads and clearly visible floral backdrop on both sides and above. This must absolutely NOT be a tight close-up headshot or a zoomed-in face-and-shoulders crop. Bright, warm, and cozy professional photo studio lighting with soft golden warmth (like a well-lit indoor photo studio, not flat or cold), gentle shallow depth of field, professional studio portrait photography, cheerful and upbeat atmosphere. The person kneels down close to the pet with an arm gently around it, both facing the camera directly with a big bright cheerful smile, eyes crinkled with joy, classic straightforward portrait pose, natural skin tones, the pet's fur and the person's face must closely match the reference photos. Horizontal orientation, high resolution, no text, no watermark.`,
  },
  {
    key: 'cone-hat',
    label: '고깔 쓴 귀여운 사진',
    prompt: `Using three reference photos — a person's portrait photo, a pet's photo, and an elegant vintage floral pattern backdrop — create one photorealistic professional portrait that places the person and pet naturally in front of the exact floral pattern backdrop shown in the third reference photo, matching its colors and floral pattern exactly; do not invent a different backdrop. Frame it as a wide three-quarter or full-body shot taken from several steps back — both the person and the pet should be visible from at least the waist up (full body preferred), occupying only the center portion of the frame, with generous headroom above their heads and clearly visible floral backdrop on both sides and above. This must absolutely NOT be a tight close-up headshot or a zoomed-in face-and-shoulders crop. Bright, warm, and cozy professional photo studio lighting with soft golden warmth (like a well-lit indoor photo studio, not flat or cold), gentle shallow depth of field, professional studio portrait photography, cheerful and upbeat atmosphere. Both the person and the pet are wearing cute colorful birthday party cone hats with small pom-poms on top, both smiling brightly with big joyful grins and looking cheerful and playful, festive and fun mood, natural skin tones, the pet's fur and the person's face must closely match the reference photos. Horizontal orientation, high resolution, no text, no watermark.`,
  },
  {
    key: 'hanbok',
    label: '한복 입은 사진',
    prompt: `Using three reference photos — a person's portrait photo, a pet's photo, and an elegant vintage floral pattern backdrop — create one photorealistic professional portrait that places the person and pet naturally in front of the exact floral pattern backdrop shown in the third reference photo, matching its colors and floral pattern exactly; do not invent a different backdrop. Frame it as a wide three-quarter or full-body shot taken from several steps back — both the person and the pet should be visible from at least the waist up (full body preferred), occupying only the center portion of the frame, with generous headroom above their heads and clearly visible floral backdrop on both sides and above. This must absolutely NOT be a tight close-up headshot or a zoomed-in face-and-shoulders crop. Bright, warm, and cozy professional photo studio lighting with soft golden warmth (like a well-lit indoor photo studio, not flat or cold), gentle shallow depth of field, professional studio portrait photography, cheerful and upbeat atmosphere. Both the person and the pet are dressed in beautiful traditional Korean hanbok. Match the hanbok style to the person's gender exactly as shown in the reference photo: if the person is male, dress them in a men's hanbok (a jeogori jacket paired with baji trousers, no skirt); if the person is female, dress them in a women's hanbok (a jeogori jacket paired with a full flowing chima skirt). Use vivid jewel-toned silk fabric and elegant embroidery, sized appropriately for each (a small tailored hanbok-style outfit for the pet), both looking graceful and proud with a big bright warm smile, natural skin tones, the pet's fur and the person's face must closely match the reference photos. Horizontal orientation, high resolution, no text, no watermark.`,
  },
  {
    key: 'military',
    label: '군복 입은 사진',
    prompt: `Using three reference photos — a person's portrait photo, a pet's photo, and an elegant vintage floral pattern backdrop — create one photorealistic professional portrait that places the person and pet naturally in front of the exact floral pattern backdrop shown in the third reference photo, matching its colors and floral pattern exactly; do not invent a different backdrop. Frame it as a wide three-quarter or full-body shot taken from several steps back — both the person and the pet should be visible from at least the waist up (full body preferred), occupying only the center portion of the frame, with generous headroom above their heads and clearly visible floral backdrop on both sides and above. This must absolutely NOT be a tight close-up headshot or a zoomed-in face-and-shoulders crop. Bright, warm, and cozy professional photo studio lighting with soft golden warmth (like a well-lit indoor photo studio, not flat or cold), gentle shallow depth of field, professional studio portrait photography, cheerful and upbeat atmosphere. Both the person and the pet are wearing matching Republic of Korea Army (ROK Army) digital pixelated camouflage combat uniforms in the official mottled dark green, brown, and khaki camo pattern (a small tailored version of the same camouflage uniform for the pet), standing proudly together side by side with a confident, bright, and endearing smile, natural skin tones, the pet's fur and the person's face must closely match the reference photos. Horizontal orientation, high resolution, no text, no watermark.`,
  },
];
...
const SHARED_BG_OPENING =
  `Using three reference photos — a person's portrait photo, a pet's photo, and an elegant vintage floral pattern backdrop — create one photorealistic professional portrait that places the person and pet naturally in front of the exact floral pattern backdrop shown in the third reference photo, matching its colors and floral pattern exactly; do not invent a different backdrop. Frame it as a wide three-quarter or full-body shot taken from several steps back — both the person and the pet should be visible from at least the waist up (full body preferred), occupying only the center portion of the frame, with generous headroom above their heads and clearly visible floral backdrop on both sides and above. This must absolutely NOT be a tight close-up headshot or a zoomed-in face-and-shoulders crop. Bright, warm, and cozy professional photo studio lighting with soft golden warmth (like a well-lit indoor photo studio, not flat or cold), gentle shallow depth of field, professional studio portrait photography, cheerful and upbeat atmosphere. `;

const FALLBACK_NO_BG_OPENING =
  `Using the two reference photos (a person's portrait photo and a pet's photo), create one photorealistic professional portrait that places them in front of an elegant vintage floral pattern backdrop in soft pastel tones. Frame it as a wide three-quarter or full-body shot taken from several steps back — both the person and the pet should be visible from at least the waist up (full body preferred), occupying only the center portion of the frame, with generous headroom above their heads and clearly visible floral backdrop on both sides and above. This must absolutely NOT be a tight close-up headshot or a zoomed-in face-and-shoulders crop. Bright, warm, and cozy professional photo studio lighting with soft golden warmth (like a well-lit indoor photo studio, not flat or cold), gentle shallow depth of field, professional studio portrait photography, cheerful and upbeat atmosphere. `;
